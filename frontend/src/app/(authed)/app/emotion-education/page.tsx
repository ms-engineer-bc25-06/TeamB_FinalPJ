...
export default function EmotionEducationPage() {
  ...
  const educationContent = {
    what: {
      title: '感情教育とは？',
      content: `　感情教育は、非認知能力の中でも「感情と人間関係」に関わる力を集中的に伸ばす教育であり、非認知能力全体を育むための土台となります。
　子どもや大人が「自分の感情を理解し、適切に表現・コントロールし、他者と健全な関係を築く力」を育む教育です。
怒りや悲しみといったネガティブな感情だけでなく、喜びや驚きなど多様な感情を理解し、言葉で表現できるようにすることで、共感や信頼などの社会的スキルも高まることが期待されます。`
    },
    importance: {
      title: 'なぜ大切なのか？',
      content: 
